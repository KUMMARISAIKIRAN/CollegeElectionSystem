<%@page import="java.sql.DriverManager"%>
    ...
    <html>
    <head>
<link rel="stylesheet" href="st.css" type="text/css"></link>
 <h1><center>STUDENT POLL</center></h1>
</head>
    ...
    try{
      ...
      PreparedStatement  pstmt= con.prepareStatement("select * from students1");
      ResultSet rs = pstmt.executeQuery();
      %>
    <center>  
    <form name="f" action="std.jsp" method="post" > 
