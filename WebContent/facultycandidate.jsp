<%@page import="java.sql.DriverManager"%>
    ...
    <!DOCTYPE html>
    <html>
    <link rel="stylesheet" href="fa.css" type="text/css"></link>
 <h1><center>FACULTY POLL</center></h1>
    <body>
    ...
    try{
      ...
      PreparedStatement  pstmt= con.prepareStatement("select * from faculty2");
      ResultSet rs = pstmt.executeQuery();
      %>
    <center>  
    <form name="f" action="bfaculty.jsp" method="post" > 
...
<input type=text required name="sid" placeholder="Id Number"><br><br>
      ...
      <label><b>Select your Candidate</b></label>
<select name="cand">
    <% 
 while(rs.next()){
    %>
